...
<div id="skinIndex" class="skinWrapper en">
    <header id="headBody">
        <div class="headLogo">
            <h1 class="logo"><a href="/english/tabid/246/Default.aspx"><img src="<%= SkinPath %>images/logo.png" alt="MST Insurance Service Co.,Ltd."/></a></h1>
        </div>
        <div class="headWrap">

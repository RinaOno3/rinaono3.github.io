...
## plugins/Comments/lib/Comments/App/CMS.pm
	...
	'Delete all Spam comments' => 'すべてのスパムコメントを削除する',
...
## plugins/Comments/lib/MT/CMS/Comment.pm
	...
	q{Comment (ID:[_1]) by '[_2]' deleted by '[_3]' from entry '[_4]'} => q{'[_3]'が記事'[_4]'への'[_2]'からのコメント(ID:[_1]))を削除しました。},
